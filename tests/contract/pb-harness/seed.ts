 ...
 * `ensureCollections`/Anexo A, que no cubre un `maxSelect` arbitrario —el fixture usa 2 y 3, y
 * el puerto solo compila 1 o 99—, `email` y las vistas/etc.) y, antes de cada test,
