 ...
 * `ensureCollections`/Anexo A: aunque ya expresa colecciones `auth` y sus reglas, sigue sin cubrir
 * un `maxSelect` arbitrario —el fixture usa 2 y 3, y el puerto solo compila 1 o 99—, un campo
 * `email` de contenido ni las vistas/etc.) y, antes de cada test,
